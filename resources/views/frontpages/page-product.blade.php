                    ...
                    <div class="col-lg-8 push-lg-2">
                        ...
                        <div class="product-single">
                            ...
                            <div class="product-content">
                                ...
                                <p class="lead">Nam eleifend elementum sapien et bibendum. Nunc ac diam efficitur, ultrices lorem quis, consectetur odio. Nullam vulputate, eros quis accumsan cursus, elit lectus bibendum nulla, sed dapibus ligula tellus at purus. Fusce id eros id mi cursus semper. Quisque efficitur bibendum nunc a consectetur.</p>
                                <hr class="hr-primary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <button class="btn btn-outline-primary btn-lg btn-block"><span>Add to cart</span></button>
                                    </div>
                                </div>
